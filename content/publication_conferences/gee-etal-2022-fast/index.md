...
publishDate: '2026-03-02T12:28:22.153657Z'
...
abstract: Real-world business applications require a trade-off between language model
  ...
  on vocabulary transfer. We evaluate the method on various vertical domains and downstream
  tasks. Our results indicate that vocabulary transfer can be effectively used in
  combination with other compression techniques, yielding a significant reduction
  in model size and inference time while marginally compromising on performance.
